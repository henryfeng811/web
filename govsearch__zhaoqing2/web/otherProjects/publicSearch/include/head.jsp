...
<%!
	...
	String database		= "zqsqlgk";
	
	public static final String SQL="DOCID2;DOCPUBURL;DOCPUBTIME;ZQLB;SSDW;XMMC;SSYJ;LCT;BZ;ZXMC;FDSX;CNSX;KYCFDWFXW;CFZL;XZQZDX;XZQZCS;ZSBZ;LCT2";
