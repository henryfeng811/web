...
<DIV class=main id=DefaultMain>
	...
	<DIV class=rowOfSearchNew><SPAN class=searchTipNew>&nbsp;&nbsp;信息搜索：</SPAN> 
	...
	if(strview==null)	
	{
		out.println(" <INPUT id=searchAgain type=checkbox value='1' name=searchAgain>在结果中搜索");
	}
	%>
	</DIV>
</FORM>	
	...
	if(strview!=null)	
	{
		out.println("<div class='rowOfCurrentPosition'>当前位置：<span ID='currentPosition'>"+strview+"</span></div>");
	}
	else
	{
		out.println("<div class='rowOfCurrentPosition'>搜索结果如下：<span id='currentPosition'>"+sHitKeyword+"</span></div>");
	}
	%>
