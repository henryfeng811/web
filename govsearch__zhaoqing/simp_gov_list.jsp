...
<% 
	...
	String sword="",searchColumn="",searchYear="",SType="" ,sThemeCatId="";
	String viewDate="";
	String sHitKeyword = ""; 
	...
	sThemeCatId = getNullStringAndEncoding(request.getParameter("ThemeCatId"));
	...
	if(SType.equals("2")){
		...
		if(sThemeCatId!=null||sThemeCatId.length()>0)
			{
				sWhere = "themecat=(" + sThemeCatId + ")";
				order = "-PubDate,-fileNum";
			}
...
<DIV class=main id=DefaultMain>
	<FORM id="trssearchform" name="trssearchform"  action="simp_gov_list.jsp" method=post>
